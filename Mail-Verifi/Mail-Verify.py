...
banner1 = c.magenta + """
 __   __  _______  ___   ___             __   __  _______  ______    ___   _______  __   __ 
|  |_|  ||   _   ||   | |   |           |  | |  ||       ||    _ |  |   | |       ||  | |  |
|       ||  |_|  ||   | |   |     ____  |  |_|  ||    ___||   | ||  |   | |    ___||  |_|  |
|       ||       ||   | |   |    |____| |       ||   |___ |   |_||_ |   | |   |___ |       |
|       ||       ||   | |   |___        |       ||    ___||    __  ||   | |    ___||_     _|
| ||_|| ||   _   ||   | |       |        |     | |   |___ |   |  | ||   | |   |      |   |  
|_|   |_||__| |__||___| |_______|         |___|  |_______||___|  |_||___| |___|      |___|  
...
if parse.email and parse.file:
    print('{}[!] Argumento Invalido!'.format(c.red))
    ...
    if path.exists(parse.file):
        ...
        for email in list_emails:
            if "@" in email:
                ...
                print("{}[!] Email incorrecto: ".format(c.red) + email)
